...
<body style="background-image:url(images/cancelback.jpg)">
	...
	<div class="sucontainer">
		<label style="font-size:20px" >Séléctionner le rendez-vous à annuler:</label><br>
		<select name="appointment" id="appointment-list" class="demoInputBox"  style="width:100%;height:35px;border-radius:9px">
		<option value="">Séléctionner le rendez-vous</option>
		<?php
		session_start();
...
if(isset($_POST['submit']))
{
		...
		$updatequery="update book set Status='Annulé par le patient' where username='$username' and timestamp= '$timestamp'";
				if (mysqli_query($conn, $updatequery)) 
				{
							echo "Rendez-vous annulé avec succées..!!<br>";
